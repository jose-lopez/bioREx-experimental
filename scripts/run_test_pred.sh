...
in_pubtator_file="samples/sample.aioner.biored.pubtator"
out_tsv_file="samples/out_processed.tsv"
out_pubtator_file="samples/sample.aioner.biored.predict.pubtator"
